...
| Clade         | Species                  | ANNEVO | Tiberius | Helixer |
|---------------|--------------------------|-------:|---------:|--------:|
| Mammalia      | Homo_sapiens             |  39.63 |   140.98 |  892.27 |
| Mammalia      | Rattus_norvegicus        |  36.75 |   113.03 |  754.98 |
| Insecta       | Drosophila_melanogaster  |   6.25 |    12.18 |   43.62 |
| Insecta       | Bombyx_mori              |   6.17 |    17.85 |  126.42 |
| Fungi         | Saccharomyces_cerevisiae |   0.22 |     1.02 |    1.50 |
| Fungi         | Candida_albicans         |   0.22 |     1.08 |    1.37 |
| Magnoliopsida | Arabidopsis_thaliana     |   1.23 |     5.67 |   10.23 |
| Magnoliopsida | Oryza_sativa             |   3.83 |    16.23 |   54.90 |
| Aves          | Gallus_gallus            |  12.93 |    51.15 |  357.37 |
| Aves          | Melopsittacus_undulatus  |  14.13 |    60.78 |  404.83 |
| Actinopteri   | Danio_rerio              |  16.62 |    67.40 |  585.95 |
| Actinopteri   | Oryzias_latipes          |   8.20 |    35.67 |  205.87 |
| Average       | Average                  |  12.18 |    43.59 |  286.61 |

We used a single RTX 4090 for the comparison, as this represents a hardware setup that is affordable for most GPU users. On the human genome, ANNEVO required 30 minutes for prediction and 10 minutes for decoding, for a total runtime of 40 minutes. In comparison, Tiberius required 141 minutes using a batch size of 8, which was the largest batch size that could run on an RTX 4090, whereas Helixer required 956 minutes.
...
When no GPU was available, on human genome, using a machine with 64 CPU cores, ANNEVO required 423 minutes for prediction and 10 minutes for decoding, for a total runtime of 433 minutes on the human genome. In comparison, Tiberius required 528 minutes and Helixer required 1381 minutes.