...
def main():
    ...
    parser.add_argument('--fine_tune_species_list', required=True, help='Path to the training species list.')
    ...
    tuning(fine_tune_species_list, args.model_path, args.model_save_path, args.h5_path, args.learning_rate, args.epoch, args.batch_size,
